...
//    static Layout * addIconHeart (Node * p, Vec2 pos, ALIGNMENT align, float fontSize, COLOR_RGB color, const string sz = "");
    ...
    static void runFlyEffect(Node * p, CallFunc * pCallFunc = NULL, float duration = 1.f, bool isDown = false, bool isRemoveSelf = false);
    static void addBlinkStar(Node * p, CallFunc * pCallFunc = NULL, float duration = 1.5f, Color3B color = Color3B::WHITE);
};
#endif //_UI_EXT_H
